...
dinheiro = tonumber(dinheiro)

if nick ~= nil or valor ~= nil or dinheiro < 100 then
  ...
  vRPclient.notify(src,{"~w~[~r~Contrato~w~]~r~ ~g~Use o comando /contrato nick valor, valor minimo R$100"})
